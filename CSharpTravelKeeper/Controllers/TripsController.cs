...
namespace CSharpTravelKeeper.Controllers
{
    ...
    public class TripsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,StartDate,EndDate,IsFavorite,Notes,Photos,ApplicationUserId")] Trip trip)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,StartDate,EndDate,IsFavorite,Notes,Photos,ApplicationUserId")] Trip trip)
        {
            if (id != trip.Id)
            {
                return NotFound();
